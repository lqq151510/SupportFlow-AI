CREATE TABLE knowledge_chunks (
 id BIGINT NOT NULL PRIMARY KEY, tenant_id BIGINT NOT NULL, knowledge_base_id BIGINT NOT NULL, document_id BIGINT NOT NULL, chunk_no INT NOT NULL, content CLOB NOT NULL, created_at TIMESTAMP(3) NOT NULL,
