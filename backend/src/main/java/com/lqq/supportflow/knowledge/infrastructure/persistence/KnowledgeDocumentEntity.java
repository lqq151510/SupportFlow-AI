...
@TableName("knowledge_documents") public class KnowledgeDocumentEntity { @TableId(type=IdType.ASSIGN_ID) public Long id; public Long tenantId; public Long knowledgeBaseId; public String fileName; public String contentHash; public String status; public String errorCode; public Integer retryCount; public Instant createdAt; public Instant updatedAt; }
