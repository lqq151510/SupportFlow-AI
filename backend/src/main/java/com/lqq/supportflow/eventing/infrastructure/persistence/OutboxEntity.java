...
@TableName("event_outbox") public class OutboxEntity { @TableId(type=IdType.ASSIGN_ID) public Long id; public Long tenantId; public String eventType; public String aggregateType; public String aggregateId; public String payload; public String status; public Integer attemptCount; public Instant nextAttemptAt; public String lastError; public Instant failedAt; public Instant createdAt; public Instant publishedAt; }
