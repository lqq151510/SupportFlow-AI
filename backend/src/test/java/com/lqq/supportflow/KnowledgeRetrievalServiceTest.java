...
class KnowledgeRetrievalServiceTest {
    ...
    void mergesOnlyTenantKnowledgeBaseResultsByScore() {
        ...
        assertThat(new KnowledgeRetrievalService(bases, search).retrieve(7L, "refund")).singleElement().satisfies(citation -> { assertThat(citation.knowledgeBaseId()).isEqualTo(2L); assertThat(citation.content()).isEqualTo("30-day refund policy"); assertThat(citation.rank()).isEqualTo(1); });
    }
}
